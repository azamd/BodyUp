...
class srcApp_KernelDevDebugContainer extends Container
{
    ...
    {
        $a = new \Symfony\Component\Cache\Adapter\FilesystemAdapter('KkqbL2R-eL', 0, ($this->targetDir.''.'/pools'), new \Symfony\Component\Cache\Marshaller\DefaultMarshaller(NULL));
    ...
    {
        return $this->services['cache.system'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('tdrpyvX7W+', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService())));
    }
    ...
    {
        return $this->privates['cache.annotations'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('fxlVMUC3KY', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService())));
    }
    ...
    {
        return $this->privates['cache.property_info'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('ggkZCMBRA+', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService())));
    }
    ...
    {
        return $this->privates['cache.serializer'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('Gtv7fySmVm', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService())));
    }
    ...
    {
        return $this->privates['cache.validator'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('00x1eZyLs3', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService())));
    }
...
class EntityManager_9a5be93 extends \Doctrine\ORM\EntityManager implements \ProxyManager\Proxy\VirtualProxyInterface
{
     ...
     */
    private $valueHolder1d66d = null;

    /**
     * @var \Closure|null initializer responsible for generating the wrapped object
     */
    private $initializerb3a85 = null;

    /**
     * @var bool[] map of public properties of the parent class
     */
    private static $publicProperties37722 = [
        
    ];

    public function getConnection()
    {
        $this->initializerb3a85 && ($this->initializerb3a85->__invoke($valueHolder1d66d, $this, 'getConnection', array(), $this->initializerb3a85) || 1) && $this->valueHolder1d66d = $valueHolder1d66d;

        return $this->valueHolder1d66d->getConnection();
    }

    public function getMetadataFactory()
    {
        $this->initializerb3a85 && ($this->initializerb3a85->__invoke($valueHolder1d66d, $this, 'getMetadataFactory', array(), $this->initializerb3a85) || 1) && $this->valueHolder1d66d = $valueHolder1d66d;

        return $this->valueHolder1d66d->getMetadataFactory();
    }

    public function getExpressionBuilder()
    {
        $this->initializerb3a85 && ($this->initializerb3a85->__invoke($valueHolder1d66d, $this, 'getExpressionBuilder', array(), $this->initializerb3a85) || 1) && $this->valueHolder1d66d = $valueHolder1d66d;

        return $this->valueHolder1d66d->getExpressionBuilder();
    }

    public function beginTransaction()
    {
        $this->initializerb3a85 && ($this->initializerb3a85->__invoke($valueHolder1d66d, $this, 'beginTransaction', array(), $this->initializerb3a85) || 1) && $this->valueHolder1d66d = $valueHolder1d66d;

        return $this->valueHolder1d66d->beginTransaction();
    }

    public function getCache()
    {
        $this->initializerb3a85 && ($this->initializerb3a85->__invoke($valueHolder1d66d, $this, 'getCache', array(), $this->initializerb3a85) || 1) && $this->valueHolder1d66d = $valueHolder1d66d;

        return $this->valueHolder1d66d->getCache();
    }

    public function transactional($func)
    {
        $this->initializerb3a85 && ($this->initializerb3a85->__invoke($valueHolder1d66d, $this, 'transactional', array('func' => $func), $this->initializerb3a85) || 1) && $this->valueHolder1d66d = $valueHolder1d66d;

        return $this->valueHolder1d66d->transactional($func);
    }

    public function commit()
    {
        $this->initializerb3a85 && ($this->initializerb3a85->__invoke($valueHolder1d66d, $this, 'commit', array(), $this->initializerb3a85) || 1) && $this->valueHolder1d66d = $valueHolder1d66d;

        return $this->valueHolder1d66d->commit();
    }

    public function rollback()
    {
        $this->initializerb3a85 && ($this->initializerb3a85->__invoke($valueHolder1d66d, $this, 'rollback', array(), $this->initializerb3a85) || 1) && $this->valueHolder1d66d = $valueHolder1d66d;

        return $this->valueHolder1d66d->rollback();
    }

    public function getClassMetadata($className)
    {
        $this->initializerb3a85 && ($this->initializerb3a85->__invoke($valueHolder1d66d, $this, 'getClassMetadata', array('className' => $className), $this->initializerb3a85) || 1) && $this->valueHolder1d66d = $valueHolder1d66d;

        return $this->valueHolder1d66d->getClassMetadata($className);
    }

    public function createQuery($dql = '')
    {
        $this->initializerb3a85 && ($this->initializerb3a85->__invoke($valueHolder1d66d, $this, 'createQuery', array('dql' => $dql), $this->initializerb3a85) || 1) && $this->valueHolder1d66d = $valueHolder1d66d;

        return $this->valueHolder1d66d->createQuery($dql);
    }

    public function createNamedQuery($name)
    {
        $this->initializerb3a85 && ($this->initializerb3a85->__invoke($valueHolder1d66d, $this, 'createNamedQuery', array('name' => $name), $this->initializerb3a85) || 1) && $this->valueHolder1d66d = $valueHolder1d66d;

        return $this->valueHolder1d66d->createNamedQuery($name);
    }

    public function createNativeQuery($sql, \Doctrine\ORM\Query\ResultSetMapping $rsm)
    {
        $this->initializerb3a85 && ($this->initializerb3a85->__invoke($valueHolder1d66d, $this, 'createNativeQuery', array('sql' => $sql, 'rsm' => $rsm), $this->initializerb3a85) || 1) && $this->valueHolder1d66d = $valueHolder1d66d;

        return $this->valueHolder1d66d->createNativeQuery($sql, $rsm);
    }

    public function createNamedNativeQuery($name)
    {
        $this->initializerb3a85 && ($this->initializerb3a85->__invoke($valueHolder1d66d, $this, 'createNamedNativeQuery', array('name' => $name), $this->initializerb3a85) || 1) && $this->valueHolder1d66d = $valueHolder1d66d;

        return $this->valueHolder1d66d->createNamedNativeQuery($name);
    }

    public function createQueryBuilder()
    {
        $this->initializerb3a85 && ($this->initializerb3a85->__invoke($valueHolder1d66d, $this, 'createQueryBuilder', array(), $this->initializerb3a85) || 1) && $this->valueHolder1d66d = $valueHolder1d66d;

        return $this->valueHolder1d66d->createQueryBuilder();
    }

    public function flush($entity = null)
    {
        $this->initializerb3a85 && ($this->initializerb3a85->__invoke($valueHolder1d66d, $this, 'flush', array('entity' => $entity), $this->initializerb3a85) || 1) && $this->valueHolder1d66d = $valueHolder1d66d;

        return $this->valueHolder1d66d->flush($entity);
    }

    public function find($className, $id, $lockMode = null, $lockVersion = null)
    {
        $this->initializerb3a85 && ($this->initializerb3a85->__invoke($valueHolder1d66d, $this, 'find', array('className' => $className, 'id' => $id, 'lockMode' => $lockMode, 'lockVersion' => $lockVersion), $this->initializerb3a85) || 1) && $this->valueHolder1d66d = $valueHolder1d66d;

        return $this->valueHolder1d66d->find($className, $id, $lockMode, $lockVersion);
    }

    public function getReference($entityName, $id)
    {
        $this->initializerb3a85 && ($this->initializerb3a85->__invoke($valueHolder1d66d, $this, 'getReference', array('entityName' => $entityName, 'id' => $id), $this->initializerb3a85) || 1) && $this->valueHolder1d66d = $valueHolder1d66d;

        return $this->valueHolder1d66d->getReference($entityName, $id);
    }

    public function getPartialReference($entityName, $identifier)
    {
        $this->initializerb3a85 && ($this->initializerb3a85->__invoke($valueHolder1d66d, $this, 'getPartialReference', array('entityName' => $entityName, 'identifier' => $identifier), $this->initializerb3a85) || 1) && $this->valueHolder1d66d = $valueHolder1d66d;

        return $this->valueHolder1d66d->getPartialReference($entityName, $identifier);
    }

    public function clear($entityName = null)
    {
        $this->initializerb3a85 && ($this->initializerb3a85->__invoke($valueHolder1d66d, $this, 'clear', array('entityName' => $entityName), $this->initializerb3a85) || 1) && $this->valueHolder1d66d = $valueHolder1d66d;

        return $this->valueHolder1d66d->clear($entityName);
    }

    public function close()
    {
        $this->initializerb3a85 && ($this->initializerb3a85->__invoke($valueHolder1d66d, $this, 'close', array(), $this->initializerb3a85) || 1) && $this->valueHolder1d66d = $valueHolder1d66d;

        return $this->valueHolder1d66d->close();
    }

    public function persist($entity)
    {
        $this->initializerb3a85 && ($this->initializerb3a85->__invoke($valueHolder1d66d, $this, 'persist', array('entity' => $entity), $this->initializerb3a85) || 1) && $this->valueHolder1d66d = $valueHolder1d66d;

        return $this->valueHolder1d66d->persist($entity);
    }

    public function remove($entity)
    {
        $this->initializerb3a85 && ($this->initializerb3a85->__invoke($valueHolder1d66d, $this, 'remove', array('entity' => $entity), $this->initializerb3a85) || 1) && $this->valueHolder1d66d = $valueHolder1d66d;

        return $this->valueHolder1d66d->remove($entity);
    }

    public function refresh($entity)
    {
        $this->initializerb3a85 && ($this->initializerb3a85->__invoke($valueHolder1d66d, $this, 'refresh', array('entity' => $entity), $this->initializerb3a85) || 1) && $this->valueHolder1d66d = $valueHolder1d66d;

        return $this->valueHolder1d66d->refresh($entity);
    }

    public function detach($entity)
    {
        $this->initializerb3a85 && ($this->initializerb3a85->__invoke($valueHolder1d66d, $this, 'detach', array('entity' => $entity), $this->initializerb3a85) || 1) && $this->valueHolder1d66d = $valueHolder1d66d;

        return $this->valueHolder1d66d->detach($entity);
    }

    public function merge($entity)
    {
        $this->initializerb3a85 && ($this->initializerb3a85->__invoke($valueHolder1d66d, $this, 'merge', array('entity' => $entity), $this->initializerb3a85) || 1) && $this->valueHolder1d66d = $valueHolder1d66d;

        return $this->valueHolder1d66d->merge($entity);
    }

    public function copy($entity, $deep = false)
    {
        $this->initializerb3a85 && ($this->initializerb3a85->__invoke($valueHolder1d66d, $this, 'copy', array('entity' => $entity, 'deep' => $deep), $this->initializerb3a85) || 1) && $this->valueHolder1d66d = $valueHolder1d66d;

        return $this->valueHolder1d66d->copy($entity, $deep);
    }

    public function lock($entity, $lockMode, $lockVersion = null)
    {
        $this->initializerb3a85 && ($this->initializerb3a85->__invoke($valueHolder1d66d, $this, 'lock', array('entity' => $entity, 'lockMode' => $lockMode, 'lockVersion' => $lockVersion), $this->initializerb3a85) || 1) && $this->valueHolder1d66d = $valueHolder1d66d;

        return $this->valueHolder1d66d->lock($entity, $lockMode, $lockVersion);
    }

    public function getRepository($entityName)
    {
        $this->initializerb3a85 && ($this->initializerb3a85->__invoke($valueHolder1d66d, $this, 'getRepository', array('entityName' => $entityName), $this->initializerb3a85) || 1) && $this->valueHolder1d66d = $valueHolder1d66d;

        return $this->valueHolder1d66d->getRepository($entityName);
    }

    public function contains($entity)
    {
        $this->initializerb3a85 && ($this->initializerb3a85->__invoke($valueHolder1d66d, $this, 'contains', array('entity' => $entity), $this->initializerb3a85) || 1) && $this->valueHolder1d66d = $valueHolder1d66d;

        return $this->valueHolder1d66d->contains($entity);
    }

    public function getEventManager()
    {
        $this->initializerb3a85 && ($this->initializerb3a85->__invoke($valueHolder1d66d, $this, 'getEventManager', array(), $this->initializerb3a85) || 1) && $this->valueHolder1d66d = $valueHolder1d66d;

        return $this->valueHolder1d66d->getEventManager();
    }

    public function getConfiguration()
    {
        $this->initializerb3a85 && ($this->initializerb3a85->__invoke($valueHolder1d66d, $this, 'getConfiguration', array(), $this->initializerb3a85) || 1) && $this->valueHolder1d66d = $valueHolder1d66d;

        return $this->valueHolder1d66d->getConfiguration();
    }

    public function isOpen()
    {
        $this->initializerb3a85 && ($this->initializerb3a85->__invoke($valueHolder1d66d, $this, 'isOpen', array(), $this->initializerb3a85) || 1) && $this->valueHolder1d66d = $valueHolder1d66d;

        return $this->valueHolder1d66d->isOpen();
    }

    public function getUnitOfWork()
    {
        $this->initializerb3a85 && ($this->initializerb3a85->__invoke($valueHolder1d66d, $this, 'getUnitOfWork', array(), $this->initializerb3a85) || 1) && $this->valueHolder1d66d = $valueHolder1d66d;

        return $this->valueHolder1d66d->getUnitOfWork();
    }

    public function getHydrator($hydrationMode)
    {
        $this->initializerb3a85 && ($this->initializerb3a85->__invoke($valueHolder1d66d, $this, 'getHydrator', array('hydrationMode' => $hydrationMode), $this->initializerb3a85) || 1) && $this->valueHolder1d66d = $valueHolder1d66d;

        return $this->valueHolder1d66d->getHydrator($hydrationMode);
    }

    public function newHydrator($hydrationMode)
    {
        $this->initializerb3a85 && ($this->initializerb3a85->__invoke($valueHolder1d66d, $this, 'newHydrator', array('hydrationMode' => $hydrationMode), $this->initializerb3a85) || 1) && $this->valueHolder1d66d = $valueHolder1d66d;

        return $this->valueHolder1d66d->newHydrator($hydrationMode);
    }

    public function getProxyFactory()
    {
        $this->initializerb3a85 && ($this->initializerb3a85->__invoke($valueHolder1d66d, $this, 'getProxyFactory', array(), $this->initializerb3a85) || 1) && $this->valueHolder1d66d = $valueHolder1d66d;

        return $this->valueHolder1d66d->getProxyFactory();
    }

    public function initializeObject($obj)
    {
        $this->initializerb3a85 && ($this->initializerb3a85->__invoke($valueHolder1d66d, $this, 'initializeObject', array('obj' => $obj), $this->initializerb3a85) || 1) && $this->valueHolder1d66d = $valueHolder1d66d;

        return $this->valueHolder1d66d->initializeObject($obj);
    }

    public function getFilters()
    {
        $this->initializerb3a85 && ($this->initializerb3a85->__invoke($valueHolder1d66d, $this, 'getFilters', array(), $this->initializerb3a85) || 1) && $this->valueHolder1d66d = $valueHolder1d66d;

        return $this->valueHolder1d66d->getFilters();
    }

    public function isFiltersStateClean()
    {
        $this->initializerb3a85 && ($this->initializerb3a85->__invoke($valueHolder1d66d, $this, 'isFiltersStateClean', array(), $this->initializerb3a85) || 1) && $this->valueHolder1d66d = $valueHolder1d66d;

        return $this->valueHolder1d66d->isFiltersStateClean();
    }

    public function hasFilters()
    {
        $this->initializerb3a85 && ($this->initializerb3a85->__invoke($valueHolder1d66d, $this, 'hasFilters', array(), $this->initializerb3a85) || 1) && $this->valueHolder1d66d = $valueHolder1d66d;

        return $this->valueHolder1d66d->hasFilters();
    }
    ...
    public static function staticProxyConstructor($initializer)
    {
        ...
        $instance->initializerb3a85 = $initializer;
    ...
    protected function __construct(\Doctrine\DBAL\Connection $conn, \Doctrine\ORM\Configuration $config, \Doctrine\Common\EventManager $eventManager)
    {
        ...
        if (! $this->valueHolder1d66d) {
            $reflection = $reflection ?? new \ReflectionClass('Doctrine\\ORM\\EntityManager');
            $this->valueHolder1d66d = $reflection->newInstanceWithoutConstructor();
        \Closure::bind(function (\Doctrine\ORM\EntityManager $instance) {
            unset($instance->config, $instance->conn, $instance->metadataFactory, $instance->unitOfWork, $instance->eventManager, $instance->proxyFactory, $instance->repositoryFactory, $instance->expressionBuilder, $instance->closed, $instance->filterCollection, $instance->cache);
        ...
        $this->valueHolder1d66d->__construct($conn, $config, $eventManager);
    }

    public function & __get($name)
    {
        $this->initializerb3a85 && ($this->initializerb3a85->__invoke($valueHolder1d66d, $this, '__get', ['name' => $name], $this->initializerb3a85) || 1) && $this->valueHolder1d66d = $valueHolder1d66d;

        if (isset(self::$publicProperties37722[$name])) {
            return $this->valueHolder1d66d->$name;
        }

        $realInstanceReflection = new \ReflectionClass('Doctrine\\ORM\\EntityManager');

        if (! $realInstanceReflection->hasProperty($name)) {
            $targetObject = $this->valueHolder1d66d;
    ...
    {
        $this->initializerb3a85 && ($this->initializerb3a85->__invoke($valueHolder1d66d, $this, '__set', array('name' => $name, 'value' => $value), $this->initializerb3a85) || 1) && $this->valueHolder1d66d = $valueHolder1d66d;
    ...
    {
        $this->initializerb3a85 && ($this->initializerb3a85->__invoke($valueHolder1d66d, $this, '__isset', array('name' => $name), $this->initializerb3a85) || 1) && $this->valueHolder1d66d = $valueHolder1d66d;
    ...
    {
        $this->initializerb3a85 && ($this->initializerb3a85->__invoke($valueHolder1d66d, $this, '__unset', array('name' => $name), $this->initializerb3a85) || 1) && $this->valueHolder1d66d = $valueHolder1d66d;
    ...
    {
        $this->initializerb3a85 && ($this->initializerb3a85->__invoke($valueHolder1d66d, $this, '__clone', array(), $this->initializerb3a85) || 1) && $this->valueHolder1d66d = $valueHolder1d66d;

        $this->valueHolder1d66d = clone $this->valueHolder1d66d;
    }

    public function __sleep()
    {
        $this->initializerb3a85 && ($this->initializerb3a85->__invoke($valueHolder1d66d, $this, '__sleep', array(), $this->initializerb3a85) || 1) && $this->valueHolder1d66d = $valueHolder1d66d;

        return array('valueHolder1d66d');
    }
    ...
    {
        $this->initializerb3a85 = $initializer;
    }

    public function getProxyInitializer() : ?\Closure
    {
        return $this->initializerb3a85;
    }

    public function initializeProxy() : bool
    {
        return $this->initializerb3a85 && ($this->initializerb3a85->__invoke($valueHolder1d66d, $this, 'initializeProxy', array(), $this->initializerb3a85) || 1) && $this->valueHolder1d66d = $valueHolder1d66d;
    }

    public function isProxyInitialized() : bool
    {
        return null !== $this->valueHolder1d66d;
    }

    public function getWrappedValueHolderValue()
    {
        return $this->valueHolder1d66d;
    }
}
