...
BaseForm form;
        ...
        addTab(swipe, res.getImage("back-logo.jpeg"), spacer1, "Welcome");
        ...
        RadioButton all = RadioButton.createToggle("Subscription", barGroup);
       
        all.setUIID("SelectBar");
        RadioButton feedback = RadioButton.createToggle("Gym", barGroup);
...
createPieChartForm();
  ...
  ;       
       ...
       image.addActionListener(e -> {
           try{
           new AddGymForm(
                   Resources.getGlobalResources()).show();
           }catch(Exception exx) {
    ...
    protected CategorySeries buildCategoryDataset(String title, double valuesRec,double valuesFeed) {
...
//        for (double value : values) {           
            series.add("Gym " , valuesRec);
            series.add("Subscription" , valuesFeed);
//        }
        return series;
    }
    ...
    public void createPieChartForm() {
        ...
        //float pourcentage = (li*100)/li.get(1);
            double pourcentage = (3*100)/total;
                        double pourcentage1 = (3*100)/total;
        ...
        PieChart chart = new PieChart(buildCategoryDataset("Project budget", pourcentage,pourcentage1), renderer);
            
        // Wrap the chart in a Component so we can add it to a form
        ChartComponent c = new ChartComponent(chart);
 String[] messages = {
            "Statistique Subscription % Gym "            
        };
